            ...
            <div className="grid gap-4">
              {sortedProviders.map((provider) => {
                ...
                return (
                  <div 
                    key={provider.id} 
                    className={"flex items-center justify-between p-4 rounded-xl border transition-all " + (isActive ? "bg-blue-50/50 border-blue-200 shadow-sm" : "bg-white border-slate-200 hover:border-slate-300 shadow-sm hover:shadow")}
                  >
                    <div className="flex items-center gap-4">
                      {provider.avatar_url ? (
                        <img 
